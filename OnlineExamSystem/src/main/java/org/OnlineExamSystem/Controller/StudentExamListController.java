...
<a href='ExamListController' class='active'>
...
Choose an exam and start your online test.
</p>
...
""");
		...
		try {
			...
			while (rs.next()) {
				...
				out.println("<td>");
				out.println(rs.getInt("exam_duration") + " Min");
				out.println("</td>");

				out.println("<td>");

				out.println("<a href='StartExamController?examId="
						+ examId + "'>");

				out.println("<button class='start-btn'>");
...
""");
			...
			out.println("<tr>");
			out.println("<td colspan='5' class='text-danger text-center'>");
